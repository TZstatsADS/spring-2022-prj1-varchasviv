...
wordcloud(lookslike$property$term2, lookslike$property$similarity*500-min(lookslike$property$similarity)*500,rot.per=0.3,random.color=FALSE,
          colors=brewer.pal(9,"Reds"), main = "Communism - 'property'")
```
