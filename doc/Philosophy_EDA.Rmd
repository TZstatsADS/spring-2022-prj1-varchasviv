...
The model identifies the 8 following unlabeled topics across both schools. For each topic, we list a combination of the most popular and salient terms.
...
datatable(rbind(t(topics.terms),ldaOut.terms), rownames = FALSE, filter="top", options = list(pageLength = 15, scrollX=T) )
```
