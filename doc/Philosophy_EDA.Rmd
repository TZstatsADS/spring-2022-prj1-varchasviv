...
draw_word_cloud <- function(word){
  ...
  lookslike_communism <-predict(model_communism,c("property"),type ="nearest",top_n =20)
  lookslike_capitalism <-predict(model_capitalism,c("property"),type ="nearest",top_n =20)
  ...
  grid.arrange(plot1, plot2, ncol=2, top = textGrob(paste("Word:",word),gp=gpar(fontsize=20,font=1)))
}
...
```{r}
lookslike <-predict(model_communism,c("property"),type ="nearest",top_n =20)
lookslike
lookslike <-predict(model_capitalism,c("property"),type ="nearest",top_n =50)
lookslike
```


```{r}
lookslike <-predict(model_communism,c("wages"),type ="nearest",top_n =5)
lookslike
lookslike <-predict(model_capitalism,c("wages"),type ="nearest",top_n =5)
lookslike
```
