...
Throughout history, there have been developed many a political and socioeconomic framework to better the lives of those living within it. Of these, two schools have caught the attention of the world over the last few centuries, so much so that countries have gone to war over them - communism and capitalism. These frameworks are guided by the texts of those who formulated them over the years. These ideas are inherently philosophical, as they question the very meaning of society and what it means to be a part of it. To find out what these texts are talking about, let's analyze these philosophical text using the tools of Data Science and Natural Language Processing. We are interested in looking at what words these school are using, what topics they primarily discuss, and get a sense of how they feel about certain words.

Since Communism and Capitalism are such ubiquitous topics in real life, I am aware of some of the principles of the two regimes. This may be a potential bias in my analysis. However, for the integrity of the data-driven study, I will only claim what I see through data and acknowledge any contextual opinions along the way (prefaced by "Opinion:"). At the end, we will draw comparisons between what we found and what we know.
...
The plot above gives us a very interesting story, building up on the frequency plot. It shows us the proportion of their text that each auther spends on each time. A darker rectangle implies that that author spends more time talking about that topic than a lighter rectangle. 
...
It seems like communism focuses more on the people and their welfare (Time, Socioeconomics) alongside their economy (Production). The lack of discussion of Assests indicates potentially less involvement of the people in the exchange of Assets. Similarly, the lack of discussion of Politics suggests that it may be exclusive and not open to the public. We noticed that the topic of Politics also discusses class, further suggesting that class structure may not exist under communism.
...
So. Here's what we found simply by exploring the data.

1. Word Frequency Analysis
    + Communist texts use a lot of words like "labour", "production", and "social" - a combination of economical and societal ideas.
    + Capitalist texts use a lot of words like "labour", "money", and "land" - mainly economical asset-related words.
    + This might be purely because of the nature of the topic. We got preliminary ideas about what to expect from further analysis.
    
2. Topic Modeling
    + Communist authors tend to write more about the topics of "Socieconomics", "Production", and "Time".
    + Capitalist authors tend to write more about the topics "Finance & Banking", "property", "Trade", "Politics", and "Assets".
    + This does not give us information about their stances on these topics.
    
3. Similar Word Analysis
    + Communism has "communal" views of "property". capitalism has "person"al views.
    + Communism has an un-opinionated view of "wages". Capitalism uses "wages" closely with "profits".
    + Capitalism tends to use "poor" alongside "unproductive" and "prodigal".
